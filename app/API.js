...
const Url = 'http://janebi-speed.ir:3001' ///185.190.39.92:3001
const apiKey = ({

    sendSms: `${Url}/api/register/sms/smsSend`,
    postUser: `${Url}/api/register/user/`,
    getOneUser: `${Url}/api/register/user/`,  // :num
    getOneUserid: `${Url}/api/register/user/ida`,  // :id
    getOneAdmin: `${Url}/api/admin/`,  // :num
    ...
    updateItem: `${Url}/api/Kala/`, // :id
    deleteItem: `${Url}/api/Kala/`, // :id
