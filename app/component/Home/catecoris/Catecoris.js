  ...
  return (
    <div ref={ref} className="flex-wrap flex flex-row items-center justify-evenly mt-20">
      {Categori.map((item, index) => (
        <div onClick={() => sellPageHandler(item.onvan)} key={index} className='mx-[2px] my-2 max-Wide-mobile-s:h-36 max-Wide-mobile-s:w-28 shadow-lg w-60 h-72 font-dorna flex justify-center items-center transition-all hover:shadow-2xl max-tablet-l:h-56 max-tablet-l:w-48'>
